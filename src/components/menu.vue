<template>
    <section id="sideBar" class="nav-list" :class="{'show':showMenu}">
        ...
        <section class="list-ul">
            ...
            <router-link class="icon-fenxiang iconfont item" :to="{'name':'list',query:{tab:'electric'}}">电力资源</router-link>
            <router-link class="icon-wenda iconfont item" :to="{'name':'list',query:{tab:'pool'}}">矿池</router-link>
